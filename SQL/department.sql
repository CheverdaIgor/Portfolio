...
INCOM.GetPidsCoordVerify  --Процедура возвращает данные для проверки обращения на обязательность наличия координатора
...
where --t.id_permission_type = '76'
t.id_permission_action in (57, 58, 59, 60, 61) --возвраты [HDD-579]
