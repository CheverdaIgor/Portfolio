SELECT distinct
    ...
    where /*(DZ.version = 3 and H.Housebisid in ('777777', '888888')) or*/ H.Houseid in ('626', '4489523', '4436590')
    or (DZ.Zip = '12501' or DZ.Zip = '12505' or DZ.Zip = '12506' or DZ.Zip = '12507')
    order by (DZ.Zip);
